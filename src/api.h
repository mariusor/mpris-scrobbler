 ...
 */
struct http_request *api_build_request_now_playing(const scrobble *track, CURL *handle, api_type type)
{
 ...
 *
 */
struct http_request* api_build_request_scrobble(scrobble *tracks[], size_t track_count, CURL *handle)
{
